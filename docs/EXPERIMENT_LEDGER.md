...
## 2026-08-09 — Frozen `wbc1_demo` release-evidence replay

- **Status and provenance:** detached proof at producer
  `0ef193070a9b80b81cef5a1710a1d65e0b271c15`; context, contracts, invented `wbc1_demo`, reproduce,
  export, report, and hygiene all passed. Generated bytes were not inspected.
- **Printed artifact hashes:** export
  `sha256:afcc1ed9535d9b22fb399375027792489ce6b97949f8f684682943c11152b5f9`; Markdown
  `sha256:f9173354e86b20ccabe91334136017ff03ae68b3ba4432666f6af72172fb11b8`; HTML
  `sha256:22ca8c03e78c6185e527fa4c0f7312caf7d9077619d46f795f8d8dd25c530a29`. These exactly matched
  the frozen claims; the current-head candidate was rejected for this release.
- **Product compatibility proof:** product `origin/main` at
  `7bbb8ee6f9124424b3d8362170f0f4d738f5cb43` passed 26 focused tests and
  `npm run check:method-trial-view`. This confirms the tracked fixture/schema seam only and does not
  authorize promotion, publication, real data, credentials, model calls, or telemetry.
- **Decision and limits:** this is provenance and compatibility evidence for the existing conservative
  `reject`, not a new experiment or a claim about real data. Lane-P candidate-content review,
  screenshots, publication, and owner-gated release sign-offs remain parked.
