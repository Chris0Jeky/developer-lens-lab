...
blockers: merge lab PR #8 after its final docs-and-authority head gate, review/thread sweep, and
  aging floor; the product dependency, merged-schema check, and exact producer byte comparison pass
...
exact_resume_point: finish the final hosted gate and thread sweep for lab PR #8, merge it with
  history preserved, and close the bounded programme before considering product #174
```
