...
Once Sol/Terra delegates, make native Luna the default for paved, directly verifiable L1/L2 child
work, including focused implementation, tests, checks, formatting, and mechanical triage under an
...
cross-repo contracts, and final decisions remain coordinator-owned. Risk classes, routing, and protocols
live in `.agent-harness/governor.json` and `docs/agent-system/`; non-flagship orchestrators use the
